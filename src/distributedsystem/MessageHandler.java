...
public class MessageHandler {
    ...
    public static class Metrics {
        ...
        public void printReport(long durationMs, String scenarioName) {
            ...
            // Compute the true average transactional processing latency derived from global duration
            double trueAvgLatency = (double) durationMs / Math.max(1, totalRequests.get());
            System.out.printf("Average Latency      : %.2f ms\n", trueAvgLatency);
            System.out.printf("Throughput           : %.2f ops/sec\n",
                    ((totalRequests.get() + totalReads.get()) / (Math.max(1, durationMs) / 1000.0)));
            System.out.println("==================================================\n");
        }
    }
}
